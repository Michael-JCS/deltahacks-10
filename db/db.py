...
# add a sentence to the summary set (set of sentences)
def add_summary(username, sentence):
    r.sadd(username+'_summary', sentence)
...
add_job("jack133003", "jack133003_job2")
